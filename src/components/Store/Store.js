...
export default class store extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            products: [
                { id: 1, title: 'T-SHIRT', price: 49.99, img: tshirt },
                { id: 2, title: 'APPLEWATCH', price: 199.99, img: appleWatch },
                { id: 3, title: 'AIRPOD', price: 99.99, img: airpod },
                { id: 4, title: 'iPHONE', price: 799.99, img: iPhone },
                { id: 5, title: 'PURSE', price: 59.99, img: purse },
                { id: 6, title: 'SHOES', price: 79.99, img: shoes },
                { id: 7, title: 'ACTION-FIGURE', price: 99.99, img: actionFigure },
                { id: 8, title: 'BACKPACK', price: 69.99, img: backpack },
                { id: 9, title: 'FLASH', price: 49.99, img: flash },
                { id: 10, title: 'FLOWER-POT', price: 19.99, img: flowerPot },
                { id: 11, title: 'HEADPHONE', price: 29.99, img: headphone },
                { id: 12, title: 'LAPTOP', price: 899.99, img: laptob },
            ],
